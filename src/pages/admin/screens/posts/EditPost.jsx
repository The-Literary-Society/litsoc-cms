          ...
          <article className="flex-1">
            <label htmlFor="postPicture" className="w-full cursor-pointer">
              {photo ? (
                ...
                <div className="w-full min-h-[200px] bg-amber-50/50 flex justify-center items-center">
                  <HiOutlineCamera className="w-7 h-auto text-amber-700" />
                </div>
              )}
            </label>
            <input
            ...
            <div className="mt-4 flex gap-2">
              {data?.categories.map((category) => (
                <Link
                  ...
                  className="text-amber-500 text-sm font-roboto inline-block md:text-base"
                >
                  {category.name}
                </Link>
              ))}
            ...
            <div className="d-form-control w-full">
              <label className="d-label" htmlFor="title">
                <span className="d-label-text font-semibold">Title</span>
              </label>
              <input
                id="title"
                value={title}
                className="d-input d-input-bordered border-slate-300 !outline-slate-300 !focus:border-none text-xl font-medium font-roboto text-dark-hard"
            ...
            <div className="d-form-control w-full">
              <label className="d-label" htmlFor="caption">
                <span className="d-label-text font-semibold">Caption</span>
              </label>
              <input
                id="caption"
                value={caption}
